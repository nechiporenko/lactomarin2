...
return i.apply(f,arguments)}:function(){return{}},e.viewport=a,e.scrollX=function(){return f.pageXOffset||h.scrollLeft},e.scrollY=function(){return f.pageYOffset||h.scrollTop},e.rectangle=c,e.aspect=d,e.inX=function(a,b){var d=c(a,b);return!!d&&d.right>=0&&d.left<=k()},e.inY=function(a,b){var d=c(a,b);return!!d&&d.bottom>=0&&d.top<=l()},e.inViewport=function(a,b){var d=c(a,b);return!!d&&d.bottom>=0&&d.right>=0&&d.top<=l()&&d.left<=k()},e}),jQuery.extend(verge),jQuery(document).ready(function(a){function b(){function b(){return j=verge.viewportW(),j>=1024&&i?!1:(g.removeClass("active"),void f.reloadSlider(a.extend(getSliderSettings(),{startSlide:c()})))}function c(){var a=f.getSlideCount(),b=f.getCurrentSlide();return 3>a-b&&(b=a-3),b}function e(a){var b,c=/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/,d=a.match(c);return b=d&&11==d[1].length?d[1]:!1}var f=a(".js-review-slider"),g=f.children("li"),i=!1,j=verge.viewportW();getSliderSettings=function(){var b,c={maxSlides:1,slideWidth:280,slideMargin:0},d={maxSlides:1,slideWidth:440,slideMargin:0},e={maxSlides:3,slideWidth:312,slideMargin:2,onSliderLoad:function(a){g.eq(a+1).addClass("active")},onSlideBefore:function(a,b,c){g.removeClass("active").eq(c+1).addClass("active")}},f={auto:!1,pager:!1,infiniteLoop:!1,hideControlOnEnd:!0,minSlides:1,moveSlides:1};return 480>j&&(i=!1,b=a.extend(c,f)),j>=480&&1024>j&&(i=!1,b=a.extend(d,f)),j>=1024&&(i=!0,b=a.extend(e,f)),b},f=f.bxSlider(getSliderSettings()),d.on("resize",function(){setTimeout(b,500)}),f.on("click",".js-video",function(b){b.preventDefault();var c=a(this).attr("href"),d=e(c);d&&(a("#video").find("iframe").attr("src","https://www.youtube.com/embed/"+d+"?rel=0&amp;showinfo=0;autoplay=1"),h.open("#video"))})}function c(){function b(a){function b(){var e=verge.inViewport(a,-50);e&&(d.unbind("scroll",b),c(a))}d.bind("scroll",b)}function c(b){b.each(function(){a(this).prop("Counter",0).animate({Counter:a(this).text()},{duration:4e3,easing:"swing",step:function(b){a(this).text(Math.ceil(b))}})})}var e=a(".js-counter");e.each(function(){var d=a(this);verge.inViewport(d)?c(d):b(d)})}var d=a(window),e=a("html"),f=a("body");f.append('<div id="overlay" class="overlay"></div>');var g=a("#overlay"),h=function(b){var c,e,f={};return e=a('<a class="modal__close" href="#"><i class="icon-cancel"></i></a>'),e.on("click",function(a){a.preventDefault(),f.close()}),f.center=function(){var a,b;a=Math.max(d.height()-c.outerHeight(),0)/2,b=Math.max(d.width()-c.outerWidth(),0)/2,c.css({top:a+d.scrollTop(),left:b+d.scrollLeft()})},f.open=function(b){c=a(b),c.append(e),f.center(),d.bind("resize.modal",f.center),c.show(),g.show(),g.bind("click",f.close)},f.close=function(){c.find("iframe").attr("src",""),c.hide(),g.unbind("click",f.close).hide(),d.unbind("resize.modal")},f}();a("[data-modal]").on("click",function(b){b.preventDefault();var c=a(this).data("modal");c&&h.open(c)});(function(){var b=a(".js-menu");b.find("li").has("ul").addClass("has-menu"),b.children("li").on({mouseenter:function(){a(this).find("ul:first").stop(!0,!0).fadeIn("fast"),a(this).find("a:first").addClass("hover")},mouseleave:function(){a(this).find("ul").stop(!0,!0).hide(),a(this).find("a:first").removeClass("hover")}})})(),function(){var b=a(".js-mnav"),c=a(".js-mnav-toggle"),d=b.find("li").has("ul").addClass("has-menu").children("a"),f=b.find(".has-menu").children("ul"),h={};return a(".header__inner").on("click",".js-mnav-toggle",function(){a(this).hasClass("active")?h.close():h.show()}),b.on("click",".m-menu__label",function(){h.close()}),b.on("click",".has-menu > a",function(b){b.preventDefault(),a(this).hasClass("active")?h.closeSubMenu():(h.closeSubMenu(),h.showSubMenu(a(this)))}),h.show=function(){e.css("overflow","hidden"),g.addClass("mobile").show().bind("click",h.close),c.addClass("active"),b.addClass("active")},h.close=function(){g.removeClass("mobile").hide().unbind("click",h.close),h.closeSubMenu(),c.removeClass("active"),b.removeClass("active"),e.css("overflow","auto")},h.showSubMenu=function(a){h.closeSubMenu(),a.addClass("active").parent("li").children("ul").slideDown()},h.closeSubMenu=function(){f.slideUp(),d.removeClass("active")},h}(),function(){var b=a('<div class="scroll-up-btn"><i class="icon-up-open-big"></i></div>');f.append(b),d.on("scroll",function(){a(this).scrollTop()>300?b.show():b.hide()}),b.on("click",function(){return a("html, body").animate({scrollTop:0},800),!1})}();a(".js-phone-input").mask("+7 (999) 999 - 99 - 99"),a(".js-match-height").matchHeight(),a(".js-review-slider").length&&b(),a(".js-counter").length&&c(),Modernizr.svg||a('img[src*="svg"]').attr("src",function(){return a(this).attr("src").replace(".svg",".png")}),"placeholder"in document.createElement("input")||(a("input[placeholder], textarea[placeholder]").each(function(){var b=a(this).attr("placeholder");""==this.value&&(this.value=b),a(this).focus(function(){this.value==b&&(this.value="")}).blur(function(){""==a.trim(this.value)&&(this.value=b)})}),a("form").submit(function(){a(this).find("input[placeholder], textarea[placeholder]").each(function(){this.value==a(this).attr("placeholder")&&(this.value="")})})),e.hasClass("lt-ie9")&&(a(".b-features__item:nth-child(4n)").css("margin-right",0),a(".b-features__item:nth-child(4n+1)").css("clear","left"))});